# Generated by Django 2.2.7 on 2021-01-23 02:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liked', models.ManyToManyField(blank=True, related_name='liked', to='api.Member')),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Member', verbose_name='Goldmember')),
                ('noped', models.ManyToManyField(blank=True, related_name='noped', to='api.Member')),
            ],
        ),
        migrations.AddField(
